import type { PhotoAdjustments, ResumeStyle } from "../types/resume";
...
export const buildRuntimeResumeStyleCss = (
  ...
  .resume-document[data-photo-placement="top-right"] .resume-header-body.dodge-photo {
    width: calc(100% - var(--cv-photo-base-reserve)) !important;
    max-width: calc(100% - var(--cv-photo-base-reserve)) !important;
  ...
  .resume-document[data-photo-placement="top-left"] .resume-header-body.dodge-photo {
    width: calc(100% - var(--cv-photo-base-reserve)) !important;
    max-width: calc(100% - var(--cv-photo-base-reserve)) !important;
    padding-left: 0 !important;
  }
  ...
  .resume-document .contact-info-link {
    min-width: 0;
    overflow-wrap: anywhere;
  ...
  .resume-document .job-intention-item {
